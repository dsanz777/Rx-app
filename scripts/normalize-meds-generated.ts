...
const CLASS_RULES: Array<{
  ...
  {
    pattern: /bupropion|ndri/i,
    className: "Norepinephrine-dopamine reuptake inhibitor (NDRI)",
    moa: "Inhibits norepinephrine and dopamine reuptake, increasing catecholaminergic signaling.",
    sideEffects: "Insomnia, dry mouth, tremor, anxiety, headache, and dose-related seizure risk.",
    monitoring: "Mood response, blood pressure, insomnia, and seizure-risk factors.",
  },
  {
  ...
  {
    pattern: /corticosteroid|hydrocortisone|fluticasone|dexamethasone/i,
    className: "Corticosteroid",
    moa: "Activates glucocorticoid receptors to reduce inflammatory cytokine signaling and immune activation.",
    sideEffects: "Local irritation or candidiasis with topical/inhaled use; hyperglycemia, mood change, and fluid retention with systemic exposure.",
    monitoring: "Symptom control, skin or mucosal irritation, candidiasis risk, and systemic steroid adverse effects when relevant.",
  },
  {
  ...
  {
    pattern: /snri|venlafaxine|desvenlafaxine|duloxetine/i,
    className: "Serotonin-norepinephrine reuptake inhibitor (SNRI)",
    moa: "Inhibits presynaptic serotonin and norepinephrine reuptake, increasing monoaminergic signaling.",
    sideEffects: "Nausea, sweating, insomnia, blood pressure elevation, sexual dysfunction, and withdrawal symptoms with abrupt stop.",
    monitoring: "Mood response, blood pressure, withdrawal symptoms, and suicidality risk.",
  },
  {
  ...
  {
    pattern: /proton pump inhibitor|esomeprazole|omeprazole|pantoprazole|lansoprazole/i,
    className: "Proton pump inhibitor (PPI)",
    moa: "Irreversibly inhibits the gastric H+/K+ ATPase in parietal cells, suppressing acid secretion.",
    sideEffects: "Headache, diarrhea, hypomagnesemia risk, B12 deficiency risk, and increased enteric infection risk with long-term use.",
    monitoring: "Symptom response, long-term magnesium or B12 risk, and ongoing need for chronic acid suppression.",
  },
  {
    pattern: /antifungal|clotrimazole|miconazole/i,
    className: "Azole antifungal",
    moa: "Inhibits fungal ergosterol synthesis, disrupting cell membrane integrity.",
    sideEffects: "Local burning, irritation, rash, and rare hypersensitivity reactions.",
    monitoring: "Symptom improvement, local irritation, and treatment adherence.",
  },
  {
    pattern: /antidiarrheal|loperamide/i,
    className: "Peripheral opioid antidiarrheal",
    moa: "Activates peripheral mu-opioid receptors in the gut to reduce intestinal motility.",
    sideEffects: "Constipation, cramping, dizziness, and rare serious arrhythmia risk at excessive doses.",
    monitoring: "Stool frequency, dehydration, constipation, and misuse or overdose risk.",
  },
  {
    pattern: /stool softener|docusate/i,
    className: "Stool softener",
    moa: "Acts as a surfactant to allow water and lipids to penetrate stool and soften fecal mass.",
    sideEffects: "Mild cramping, diarrhea, and throat irritation with liquid forms.",
    monitoring: "Bowel movement response, abdominal symptoms, and ongoing constipation burden.",
  },
  {
    pattern: /calcium carbonate|antacid/i,
    className: "Calcium supplement / antacid",
    moa: "Provides elemental calcium and neutralizes gastric acid in the GI tract.",
    sideEffects: "Constipation, bloating, hypercalcemia risk, and kidney stone risk with excess use.",
    monitoring: "Symptom response, total calcium intake, constipation, and hypercalcemia risk factors.",
  },
  {
    pattern: /benzocaine|topical anesthetic/i,
    className: "Topical local anesthetic",
    moa: "Blocks sodium channels locally to reduce peripheral nerve conduction and pain sensation.",
    sideEffects: "Local irritation, allergic contact reactions, and rare methemoglobinemia risk.",
    monitoring: "Pain relief, local reaction, and methemoglobinemia symptoms in high-risk use.",
  },
  {
    pattern: /hydralazine|minoxidil/i,
    className: "Direct vasodilator / hair-growth agent",
    moa: "Opens potassium channels and promotes vasodilation; topical use may prolong anagen phase in hair follicles.",
    sideEffects: "Hypertrichosis, local irritation, tachycardia, edema, and hypotension with systemic exposure.",
    monitoring: "Blood pressure when systemic, scalp irritation when topical, and treatment response.",
  },
  {
    pattern: /antihistamine|loratadine|cetirizine|diphenhydramine|hydroxyzine/i,
    className: "Histamine H1 receptor antagonist",
    moa: "Blocks peripheral and/or central histamine H1 receptors to reduce allergic symptoms or pruritus.",
    sideEffects: "Sedation varies by agent, dry mouth, dizziness, and anticholinergic effects with first-generation products.",
    monitoring: "Symptom relief, daytime sedation, anticholinergic burden, and QT-risk co-medications when relevant.",
  },
  {
    pattern: /tadalafil|sildenafil|vardenafil|pde-5/i,
    className: "Phosphodiesterase-5 (PDE-5) inhibitor",
    moa: "Inhibits phosphodiesterase-5, increasing cyclic GMP and smooth muscle relaxation in pulmonary and erectile tissue.",
    sideEffects: "Headache, flushing, dyspepsia, hypotension, nasal congestion, and vision changes.",
    monitoring: "Symptom response, blood pressure, nitrate exposure, and adverse effects.",
  },
  {
    pattern: /estradiol|estrogen|ethinyl estradiol/i,
    className: "Estrogen therapy",
    moa: "Activates estrogen receptors to replace or augment estrogen signaling in target tissues.",
    sideEffects: "Breast tenderness, nausea, headache, fluid retention, and thromboembolic risk depending on formulation and patient factors.",
    monitoring: "Symptom control, blood pressure, VTE risk factors, and abnormal bleeding.",
  },
  {
    pattern: /cyclobenzaprine|skeletal muscle relaxant/i,
    className: "Skeletal muscle relaxant",
    moa: "Acts centrally to reduce tonic somatic motor activity and relieve acute muscle spasm symptoms.",
    sideEffects: "Sedation, dizziness, dry mouth, blurred vision, and anticholinergic effects.",
    monitoring: "Sedation, anticholinergic burden, fall risk, and short-term symptom response.",
  },
  {
    pattern: /lidocaine|local anesthetic/i,
    className: "Local anesthetic",
    moa: "Blocks voltage-gated sodium channels to reduce nerve conduction and pain signaling.",
    sideEffects: "Local irritation, numbness, dizziness, and dose-related CNS or cardiac toxicity with systemic exposure.",
    monitoring: "Pain relief, local skin reaction, and systemic toxicity symptoms when high exposure is possible.",
  },
  {
