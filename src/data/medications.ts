...
const curatedRecords: MedicationRecord[] = [
  ...
  },
  {
    ...
    name: "Metformin",
    class: "Biguanide",
    summary: "First-line oral agent for type 2 diabetes; reduces hepatic glucose production.",
    dose: "Start 500 mg PO daily or BID; titrate to 1000 mg BID (max 2000-2550 mg/day).",
    renal: "Contraindicated if eGFR <30; caution if 30-45 and monitor for lactic acidosis.",
    monitoring: "Vitamin B12 annually, renal function q3-6 months, GI tolerance.",
    pearls: [
      "Extended-release formulation improves GI tolerability.",
      "Hold during contrast procedures if eGFR <60.",
      "Combines well with most agents; weight-neutral or modest loss.",
    ],
    tags: ["Diabetes", "Metabolic"],
    keywords: ["metformin", "glucophage", "diabetes", "biguanide"],
  },
  {
    slug: "atorvastatin",
    name: "Atorvastatin (Lipitor)",
    class: "Statin",
    summary: "High-intensity statin for ASCVD risk reduction; lowers LDL ~50%.",
    dose: "10-20 mg PO daily for primary prevention; 40-80 mg for secondary.",
    renal: "No adjustment needed.",
    monitoring: "Lipid panel q3-12 months, LFTs at baseline/when symptomatic, CK if myalgia.",
    pearls: [
      "Take any time of day; avoid grapefruit.",
      "Switch to rosuvastatin if muscle complaints persist.",
      "Document 10-year ASCVD score for coverage.",
    ],
    tags: ["Cardiology", "Lipids"],
    keywords: ["atorvastatin", "lipitor", "statin", "ldl", "cholesterol"],
  },
  {
    slug: "lisinopril",
    name: "Lisinopril",
    class: "ACE Inhibitor",
    summary: "Daily ACEi for HTN, HF, CKD; renoprotective in proteinuric states.",
    dose: "Start 5-10 mg PO daily; titrate to 20-40 mg (max 80 mg).",
    renal: "Reduce starting dose if CrCl <30; monitor K/Cr within 1-2 weeks.",
    monitoring: "BP, electrolytes, renal function; watch for cough/angioedema.",
    pearls: [
      "36-hr washout before ARNI switch.",
      "Avoid in pregnancy; counsel on fetal risks.",
      "Combine with thiazide for additive BP control.",
    ],
    tags: ["Hypertension", "Heart Failure", "CKD"],
    keywords: ["lisinopril", "acei", "htn", "hf", "ckd"],
  },
  {
    slug: "levothyroxine",
    name: "Levothyroxine (Synthroid)",
    class: "Thyroid hormone",
    summary: "Synthetic T4 for hypothyroidism; narrow therapeutic index.",
    dose: "Start 1.6 mcg/kg PO daily (adjust for age/weight); titrate by TSH q6-8 weeks.",
    renal: "No adjustment; monitor TSH more frequently in CKD.",
    monitoring: "TSH/free T4 q4-8 weeks initially, then annually; bone density if suppressed TSH.",
    pearls: [
      "Take on empty stomach; separate from calcium/iron by 4 hrs.",
      "Generic bioequivalence varies—stick to brand if unstable.",
      "Dose reduce 25% in elderly or cardiac disease.",
    ],
    tags: ["Endocrine", "Thyroid"],
    keywords: ["levothyroxine", "synthroid", "hypothyroidism", "tsh"],
  },
  {
    slug: "aspirin",
    name: "Aspirin",
    class: "Antiplatelet",
    summary: "Low-dose ASA for secondary CV prevention; balances bleeding risk.",
    dose: "81 mg PO daily for most indications; 325 mg for acute events.",
    renal: "No adjustment; caution in severe CKD due to bleeding risk.",
    monitoring: "Signs of GI bleed, platelet function if high-risk.",
    pearls: [
      "Enteric-coated to minimize GI upset.",
      "Avoid with NSAIDs; use PPI if history of ulcer.",
      "Primary prevention limited to high-risk patients per USPSTF.",
    ],
    tags: ["Cardiology", "Antiplatelet"],
    keywords: ["aspirin", "asa", "cv", "prevention"],
  },
];
